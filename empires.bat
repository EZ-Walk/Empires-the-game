...
:ATK_STR
if %swordtype% EQU Your set /a damage=%random%*100/32767+1
if %swordtype% EQU Wooden set /a damage=%random%*290/32767+1
if %swordtype% EQU Stone set /a damage=%random%*200/32767+1
if %swordtype% EQU Bronze set /a damage=%random%*250/32767+1
if %swordtype% EQU Iron set /a damage=%random%*300/32767+1
...
:ATK_STR_3
if %swordtype% EQU Your set /a damage=%random%*100/32767+1
if %swordtype% EQU Wooden set /a damage=%random%*200/32767+1
if %swordtype% EQU Stone set /a damage=%random%*300/32767+1
if %swordtype% EQU Bronze set /a damage=%random%*400/32767+1
if %swordtype% EQU Iron set /a damage=%random%*500/32767+1
if %swordtype% EQU Steel set /a damage=%random%*200/32767+1
if %swordtype% EQU Gold set /a damage=%random%*225/32767+1
if %swordtype% EQU Crystal set /a damage=%random%*250/32767+1
if %swordtype% EQU Sacred set /a damage=%random%*275/32767+1
...
title Empire - Weapon Shop
mode con cols=160 lines=62
cls
echo Empire - Weapon Shop
echo.
...
title Empire - Armor Shop
mode con cols=160 lines=62
cls
echo Empire - Armor Shop
echo.
echo You currently have %money% Gold.
echo.
echo.
...
title Empire - Legend's Store
mode con cols=160 lines=62
cls
echo Empire Legend's Store
echo.
echo.
echo  You currently have %money% gold. 
echo.
...
:color
title Empire - Settings - Color Change
cls
echo.
